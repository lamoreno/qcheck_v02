...
************** A. Create file that save results.;
	cap postutil clear;
	postfile resultados str10 contador str30 variable str30 warning str10 frequency str10 percentage str244 description str244 iff using check1, replace;
...
program define log_statement, rclass;
	...
	* 4. If the condition wasn't hold, we save it in the post file;		
	...
	if ("`savepost'"=="yes") {;  
		...
		* Save results;
			post resultados  ("${salt_doncontador}") ("`anything'") ("`warning'") ("`frequency'") ("`percentage'") ("`description'") ("`iff'");
					* Create a brouse;
